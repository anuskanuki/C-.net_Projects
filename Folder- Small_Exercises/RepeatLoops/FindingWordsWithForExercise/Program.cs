...
namespace FindingWordsWithForExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var wordCoumt = findByFor(Console.ReadLine());

            Console.WriteLine($"Founded: {wordCoumt}");
            Console.ReadKey();
        ...
        /// <summary>
        /// Find the word using for loop. Search methot to the application
        /// </summary>
        /// <param name="wordToFind"></param>word to do the search 
        ...
        private static int findByFor(string wordToFind)
        {
            ...
            var textLength = contentToFind.Length - 2;//-2 cause: in the end, the loop stops right in the end, not after already finished
            var contWordFind = 0;
